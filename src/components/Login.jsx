...
import logoOrbix from '../assets/image.png'; // <-- Apunta exactamente a src/assets/image.png
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Aquí renderizamos la imagen usando la variable importada de Vite */}
        <img 
        ...
        <p style={{ fontSize: '13px', color: '#f0fdfa', maxWidth: '260px', lineHeight: '1.6', margin: 0 }}>
          
        </p>
      </div>

      {/* COLUMNA DERECHA: FORMULARIOS (BLANCO / GRIS) */}
      <div style={{
        flex: '1 1 55%',
        padding: '50px 60px',
        display: 'flex',
        ...
        {activeTab === 'signin' ? (
          <form onSubmit={handleSignInSubmit}>
            ...
            <input
              ...
              required
              style={inputStyle}
              onFocus={(e) => e.target.style.borderColor = '#009990'}
            ...
            <button
              ...
              style={{
                ...
                cursor: loading ? 'not-allowed' : 'pointer', marginTop: '10px', transition: 'background-color 0.2s'
              }}
            >
